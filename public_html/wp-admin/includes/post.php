...
function get_sample_permalink_html( $id, $new_title = null, $new_slug = null ) {
	...
	if ( false === strpos( $permalink, '%postname%' ) && false === strpos( $permalink, '%pagename%' ) ) {
		...
		$return .= '<span id="edit-slug-buttons"><button type="button" class="edit-slug button button-small hide-if-no-js" aria-label="' . __( 'Edit permalink' ) . '">' . __( 'Editar' ) . "</button></span>\n";
